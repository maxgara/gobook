...
//findlinks recursively finds all the links in an html string
import (
...
// 	doc, err := html.Parse(newReader(testdoc))
// 	if err != nil {
// 		log.Fatal(err)
// 	}
...
// visit returns a string of URLs representing all the <a href> links in an HTML Node tree
func GetUrls(links []string, n *html.Node) []string {
	// fmt.Printf("node (%v) data:%s\n", n.Type, n.Data)
	...
	sb := n.NextSibling
	if ch != nil {
		links = GetUrls(links, ch)
	}
	if sb != nil {
		links = GetUrls(links, sb)
	}
	return links
}

var testdoc = `<!DOCTYPE html>
  ...
  <div class="WhoUsesCaseStudyList">
    <ul class="WhoUsesCaseStudyList-gridContainer">
        ...
        <li class="WhoUsesCaseStudyList-caseStudy">
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://bitly.com/blog/why-we-write-everything-in-go/?utm_source=go-dev&amp;utm_medium=referral&amp;utm_campaign=go-dev&amp;utm_content=case-study" aria-label="View CaseStudy of Bitly, (opens in new window)" target="_blank" rel="noopener"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://medium.com/capital-one-tech/a-serverless-and-go-journey-credit-offers-api-74ef1f9fde7f" aria-label="View CaseStudy of Capital One, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://www.cockroachlabs.com/blog/why-go-was-the-right-choice-for-cockroachdb/" aria-label="View CaseStudy of Cockroach Labs, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://blogs.dropbox.com/tech/2014/07/open-sourcing-our-go-libraries/" aria-label="View CaseStudy of Dropbox, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://blog.cloudflare.com/graceful-upgrades-in-go/" aria-label="View CaseStudy of Cloudflare, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://entgo.io/blog/2019/10/03/introducing-ent/" aria-label="View CaseStudy of Facebook, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://cloudblogs.microsoft.com/opensource/2018/02/21/go-lang-brian-ketelsen-explains-fast-growth/" aria-label="View CaseStudy of Microsoft, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://medium.com/tech-at-wildlife-studios/pitaya-wildlifes-golang-go-af57865f7a11" aria-label="View CaseStudy of Wildlife Studios, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://www.cloudwego.io/" aria-label="View CaseStudy of ByteDance, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://medium.com/netflix-techblog/application-data-caching-using-ssds-5bf25df851ef" aria-label="View CaseStudy of Netflix, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://technology.riotgames.com/news/leveraging-golang-game-development-and-operations" aria-label="View CaseStudy of Riot Games, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://www.zdnet.com/article/salesforce-why-we-ditched-python-for-googles-go-language-in-einstein-analytics/" aria-label="View CaseStudy of Salesforce, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://blog.twitch.tv/en/2016/07/05/gos-march-to-low-latency-gc-a6fa96f06eb7/" aria-label="View CaseStudy of Twitch, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://blog.twitter.com/engineering/en_us/a/2015/handling-five-billion-sessions-a-day-in-real-time.html" aria-label="View CaseStudy of Twitter, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://eng.uber.com/aresdb/" aria-label="View CaseStudy of Uber, (opens in new window)" target="_blank" rel="noopener"
              class="WhoUsesCaseStudyList-caseStudyLink">
              <img
                loading="lazy"
                height="48"
